...
-- Volcando datos para la tabla actividades.reportes: ~28 rows (aproximadamente)
...
-- Volcando datos para la tabla actividades.tareas: ~39 rows (aproximadamente)
...
INSERT INTO `tareas` (`id`, `tituloTarea`, `prioridad`, `descripcion`, `estado`, `fecha`, `users_id`, `created_at`, `updated_at`) VALUES
	...
	(7, 'Tarea User2', 'Alta', 'tarea para usuario 2 ', 'Pendiente', '2019-04-04', 2, '2019-04-04 15:11:59', '2019-04-04 15:12:05'),
	(8, 'Concierto', 'Media', 'Concierto de Amaretto en Ahuachapan', 'Pendiente', '2019-04-04', 3, '2019-04-04 15:13:47', '2019-04-04 15:13:48'),
	...
	(11, 'Prueba 3', 'Alta', 'Usuario 2', 'Pendiente', '2019-04-04', 2, '2019-04-04 16:44:09', '2019-04-04 16:44:09'),
	(12, 'Prueba', 'Alta', 'usuario 2', 'Pendiente', '2019-04-04', 2, '2019-04-04 16:47:58', '2019-04-04 16:47:58'),
	(13, 'Prueba 4', 'Alta', 'Usuario 3', 'Pendiente', '2019-04-04', 3, '2019-04-04 16:49:12', '2019-04-04 16:49:12'),
	...
	(20, 'Tarea lunes', 'Media', 'para el dia lunes', 'Pendiente', '2019-04-08', 2, '2019-04-08 08:51:56', '2019-04-08 08:51:56'),
	(21, 'Tarea S 11', 'Baja', 'Semana doce', 'Pendiente', '2019-04-08', 3, '2019-04-08 08:52:32', '2019-04-08 08:52:33'),
	...
	(30, '10-4', 'Alta', 'Tarea Tarea', 'Incumplida', '2019-04-10', 1, '2019-04-10 09:57:45', '2019-04-10 12:48:03'),
	(35, 'Tarea de prueba', 'Alta', 'tarea de prueba para los sweet alert', 'Pendiente', '2019-04-10', 2, '2019-04-10 10:01:36', '2019-04-10 10:01:36'),
	(36, 'Tarea', 'Alta', 'Descripcion', 'Incumplida', '2019-04-10', 1, '2019-04-10 10:02:05', '2019-04-10 12:48:03'),
	(37, 'Tarea de Prueba para el alumno', 'Alta', 'Se genera una tarea de prueba para el alumno!', 'Pendiente', '2019-04-10', 3, '2019-04-10 12:19:19', '2019-04-10 12:20:32'),
	(39, 'Otra tarea de prueba', 'Alta', 'nueva tarea de prueba', 'Pendiente', '2019-04-10', 3, '2019-04-10 12:26:19', '2019-04-10 12:26:19'),
	(40, 'otra tarea de prueba', 'Alta', 'Tarea en pruebas finales', 'Pendiente', '2019-04-10', 3, '2019-04-10 12:29:57', '2019-04-10 12:29:57'),
	(43, 'Tarea de prueba', 'Alta', 'descripción de prueba', 'Incumplida', '2019-04-10', 1, '2019-04-10 12:33:25', '2019-04-10 12:48:03'),
	(44, 'Otra tarea de prueba final', 'Alta', 'finales', 'Incumplida', '2019-04-10', 1, '2019-04-10 12:34:19', '2019-04-10 12:48:03'),
	(45, 'una nueva tarea de prueba', 'Alta', 'Descripcion de la tarea nueva', 'Incumplida', '2019-04-10', 1, '2019-04-10 12:45:59', '2019-04-10 12:48:03'),
	(46, '10-4 (Tarea Reasignada)', 'Alta', 'Tarea Tarea', 'Incumplida', '2019-04-10', 1, '2019-04-10 12:50:24', '2019-04-10 12:51:12'),
	(47, 'Tarea (Tarea Reasignada)', 'Alta', 'Descripcion', 'Incumplida', '2019-04-10', 1, '2019-04-10 12:50:33', '2019-04-10 12:51:12'),
	(48, 'Tarea de prueba (Tarea Reasignada)', 'Alta', 'descripción de prueba', 'Incumplida', '2019-04-10', 1, '2019-04-10 12:50:38', '2019-04-10 12:51:12'),
	(49, 'Otra tarea de prueba final (Tarea Reasignada)', 'Alta', 'finales', 'Pendiente', '2019-04-11', 1, '2019-04-10 12:50:44', '2019-04-10 12:50:44'),
	(50, 'una nueva tarea de prueba (Tarea Reasignada)', 'Alta', 'Descripcion de la tarea nueva', 'Pendiente', '2019-04-12', 1, '2019-04-10 12:50:51', '2019-04-10 12:50:51'),
	(52, 'Tarea (Tarea Reasignada)', 'Alta', 'Descripcion', 'Pendiente', '2019-04-11', 1, '2019-04-10 14:57:07', '2019-04-10 14:57:07');
